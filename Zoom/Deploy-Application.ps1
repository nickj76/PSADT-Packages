...
Try {
	...
	[string]$appVersion = '5.13.13305'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '20/01/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If ( Test-Path "$envProgramFiles\Zoom\bin") {
			Execute-Process -Path "$dirSupportFiles\CleanZoom.exe" -Parameters '/keepdata /silent' -PassThru
		}
		...
		Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'Zoom_5.13.13305' -Value '"Installed"'-Type String
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'Zoom_5.13.13305'
