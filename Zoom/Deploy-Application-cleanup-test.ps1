...
Try {
	...
	[string]$appVersion = '5.12.6'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '14/11/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'Zoom_5.12.6' -Value '"Installed"'-Type String
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'Zoom_5.12.6'
