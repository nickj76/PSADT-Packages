...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action "Install" -Path "$DirFiles\GlobalProtect64-6.1.0.msi" -Parameters "/qn /norestart CONNECTMETHOD=on-demand Portal=vpn.surrey.ac.uk" -SecureParameters -PassThru
