...
Try {
	...
	[string]$appScriptDate = '05/07/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "Ultimaker-Cura-5.0.0-win64.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envProgramFiles\Ultimaker Cura 5.0.0\Uninstall.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
