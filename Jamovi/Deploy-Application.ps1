...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\jamovi-2.3.18.0-win64.exe" -Parameters '/S' -WindowStyle 'Hidden'
		...
		Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'jamovi-2.3.18.0' -Value '"Installed"' -Type String
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$envProgramFiles\jamovi-2.3.18.0\uninstall.exe" -Parameters '/S' -WindowStyle 'Hidden'
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		##*===============================================
		##* POST-UNINSTALLATION
		##*===============================================
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'jamovi-2.3.18.0'
