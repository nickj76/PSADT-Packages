...
Try {
	...
	[string]$appVersion = '8.4.6'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/09/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "npp.8.4.6.Installer.x64.exe" /S -WindowStyle 'Hidden'
		...
		Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'Notepad++-8.4.6' -Value '"Installed"'-Type String
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'Notepad++-8.4.6'
