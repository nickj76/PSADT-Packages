...
Try {
	...
	[string]$appScriptDate = '02/11/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'R-4.2.2' -Value '"Installed"'-Type String
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		If (Test-Path -Path "$envProgramFiles\R\R-4.2.2"){
			Remove-Folder -Path "$envProgramFiles\R\R-4.2.2"
		}
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'R-4.2.2'
