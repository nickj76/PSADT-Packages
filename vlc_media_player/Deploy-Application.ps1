...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## Install VLC Player
		$exitCode = Execute-Process -Path "vlc-3.0.18-win64.exe" -Parameters "/S /L=1033 --no-qt-privacy-ask --no-qt-updates-notif" -WindowStyle 'Hidden' -PassThru -WaitForMsiExec
		...
		Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'vlc-3.0.18' -Value '"Installed"' -Type String
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'vlc-3.0.18' 
