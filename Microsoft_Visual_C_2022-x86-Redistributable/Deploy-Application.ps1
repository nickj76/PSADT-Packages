...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Set-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'VC Redist 2022 x86 14.34.31938' -Value '"Installed"' -Type String
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\Intune_Installations -Name 'VC Redist 2022 x86 14.34.31938'
