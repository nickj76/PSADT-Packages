...
Try {
	...
	[string]$appVendor = 'Corporation for Digital Scholarship'
	...
	[string]$appScriptDate = '17/10/2022'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-RegistryKey -Key HKEY_LOCAL_MACHINE\SOFTWARE\SCCM_Installations -Name 'Zotero-6.0.15'
